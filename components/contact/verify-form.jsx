  ...
  return (
    <div className="flex flex-col gap-4 border-2">
      <div className="border-b-2 bg-[#f5f6f7] p-2 py-3 ">
        <h2 className="font-medium text-[#4b4f56]">
      ...
      >
        <div className="flex flex-col items-start p-4">
          ...
          <p className="font-medium text-[#90949c]">What are you verifying?</p>
          <div class="block min-h-[1rem] font-medium ">
            <div>
              <RadioInput
                register={register}
                name="verify"
          ...
          {isPage ? (
            ...
            <>
              <div>
                <p className="text-xs font-medium mt-4">Profile link</p>
                <input
                  className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
          ...
          <SelectInput
            ...
            className="min-w-[300px] bg-white border border-slate-300 mb-4"
          />

          <p className="text-xs font-medium mb-2">Add document</p>
          <input type="file" id="myFile" name="filename" {...register('filename')}/>
          ...
          <p className="text-xs font-medium">Country / region</p>
          ...
          <input
            className="shadow-none p-1 mb-4 border border-slate-300 mt-1 min-w-[300px]"
            placeholder="Enter a country name..."
            {...register('region')}
          />

          <p className="text-xs font-medium">Audience (Optional)</p>
          <p className="text-xs text-[#90949c] my-2">
          ...
          <p className="text-xs font-medium">Also known as (Optional)</p>
          <p className="text-xs text-[#90949c] my-2">
          ...
          <p className="text-xs font-medium my-1">Link 1</p>
          <input
            className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
            {...register('link1')}
          />
          <p className="text-xs font-medium my-1">Link 2</p>
          <input
            className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
            {...register('link2')}
          />
          <p className="text-xs font-medium my-1">Link 3</p>
          <input
            className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
            {...register('link3')}
          />
          <p className="text-xs font-medium my-1">Link 4</p>
          <input
            className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
            {...register('link4')}
          />
          <p className="text-xs font-medium my-1">Link 5</p>
          <input
            className="shadow-none p-1 border border-slate-300 mt-1 min-w-[300px]"
            {...register('link5')}
          />
